...
<?php
    ...
    $resultFindIdUsers = $FindIdUsersOP->fetch(PDO::FETCH_ASSOC);
       ...
       $FindInfoNote = "SELECT * FROM Notes WHERE UserId = '{$resultFindIdUsers['UserId']}' AND Status ='Выполнено'";
    ...
    foreach($ResultFindInfoNoteOP as $arr){
        echo' <div data-id1="'.$arr['NotesId'].'" id="BlockNote" class="col-md-12 DivNote animated">';
         ...
         //   echo '<div class="col-md-12 DivTextNote">'.$arr['TextNote'].'</div>';
            ...
            echo '<a  data-id2="'.$arr['NotesId'].'" class="HiddenButtonSettings"><div  data-id2="'.$arr['NotesId'].'" class="HiddenButtonSettings" href="#ModalUpdateTitleNote">Востановить<img src="../img/settingsNoteBlock.svg"></div></a>';
