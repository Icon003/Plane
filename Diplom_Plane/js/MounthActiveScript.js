$(document).ready(function() {
    ...
    $('.ActiveTabMounth').removeClass('ActiveTabMounth');
    $(this).addClass('ActiveTabMounth');
    ...
    $(".TabMounth").each(
            function FindMounth() {
                var MounthA = $('.Bottom').find(this).data('mounth');
        ...
        $(".Day").each(
            ...
            if(YearTK == Year){
                if(fMonth == Mounth){   
                    if(Data == DayTK){
//                        alert ('c');
//                        $(this).find('.NumberDay').css('background-color', '#9b59b6');
