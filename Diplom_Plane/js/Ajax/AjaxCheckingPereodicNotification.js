function ChekingPereodicNotification(){
...
//    }
    ...
    var CurrentDate = (CurrentYear+"-"+MinimumMonth+"-"+MinimumDay);
    //Определяю дату создания заметки для последущей отправки в PHP файл.
    
    
    $.ajax({
        url: "http://d0008482.atservers.net/CheckingPereodicNotification.php",
        type: "POST",
        data:{
        ...
        dataType: "html",
        success: SuccesAjaxCheckingPeriodicNotification
    });
}


function SuccesAjaxCheckingPeriodicNotification(data){
//    console.log(data);
...
//        var Number = obj[i].IdNotification;
        
        var options = {
            icon: "http://d0008482.atservers.net/alarm-clock.png",
//            body: Number
        };
